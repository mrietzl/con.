...
export default class Registration extends Component {
    ...
    handleSubmit(evt) {
        ...
        console.log(
            "the 'handleSubmit' event in the Registration.js was triggered. this.state is:",
            this.state
        );
        ...
        fetch("/registration.json", {
            method: "POST",
            body: JSON.stringify(
                // TODO: actually send data from user (DONE)
                newUser
            ),
            headers: {
            ...
            if (res.ok) {
                ...
                // TODO: show error message to user (DONE)
                // by updating the `error` property in state
        ...
        return (
            <div>
                ...
                <p className="font-sans text-[#F2F2F2] mb-8">
                    Please register here to create a new account:
                </p>
                <form
                ...
                <button className="mt-4 px-6 h-12 uppercase font-semibold tracking-wider rounded-lg border-2 border-[#F2F2F2] text-[#F2F2F2] hover:border-[#D7F205] hover:text-[#D7F205] hover:cursor-alias">
